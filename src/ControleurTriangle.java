...
public class ControleurTriangle extends MouseInputAdapter implements ControleurFigure{
	...
	public void mouseDragged(MouseEvent e){		
		if (edition && !dessiner) {	
			if (triangle.isInsideCercle(pointEditer, triangle.getP1())) 
				triangle.setLine(e.getPoint(), triangle.getP2());
			if (triangle.isInsideCercle(pointEditer, triangle.getP2()))
				triangle.setLine(triangle.getP1(), e.getPoint());
			if (triangle.isInsideCercle(pointEditer, triangle.getP3()))
